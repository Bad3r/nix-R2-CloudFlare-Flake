...
| **6.4 End-user workflows**         | Expand practical usage docs for sync, backup, annex, and worker share flows across local + remote contexts.                                           | Updated `docs/quickstart.md`, `docs/sync.md`, `docs/versioning.md`, and examples with expected outcomes.                   | Consumer integration section is complete and verified against current commands.                         | [x]    |
