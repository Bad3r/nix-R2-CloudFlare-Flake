  ...
  options.programs.r2-cloud = {
    ...
    explorerEnvFile = lib.mkOption {
      ...
      description = ''
        ...
        Intended for `R2_EXPLORER_BASE_URL`, `R2_EXPLORER_OAUTH_TOKEN_URL`,
        `R2_EXPLORER_OAUTH_CLIENT_ID`, and `R2_EXPLORER_OAUTH_CLIENT_SECRET`.
        Use a runtime path (for example
